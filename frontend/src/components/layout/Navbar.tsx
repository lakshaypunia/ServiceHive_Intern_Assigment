    ...
    <header className="bg-white border-b border-slate-200 sticky top-0 z-30">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
        ...
        <div className="flex items-center gap-2.5">
          ...
          <span className="text-slate-900 font-bold text-lg tracking-tight">Smart Leads</span>
        </div>
          ...
          <div className="relative">
            ...
            >
              ...
              <div className="hidden sm:block text-left">
                ...
                <p className="text-xs text-slate-400 mt-0.5 capitalize leading-none">
                  {user.role.replace('_', ' ')}
                </p>
              </div>
            ...
            {menuOpen && (
              <>
                ...
                <div className="absolute right-0 top-full mt-2 w-52 bg-white rounded-xl border border-slate-200 shadow-lg z-20 p-1">
